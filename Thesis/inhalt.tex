...
Nachdem die Teilkacheln gruppiert und sortiert vorliegen, können sie mithilfe des in Algorithmus~\ref{alg:regressionFlink} angegebenen Algorithmus zu Zeitreihen transformiert und dann analysiert werden.
