...
\usepackage{ngerman,graphicx,epstopdf,float,latexsym,textcomp,longtable,verbatim,dsfont, color, tikz, url, csquotes,caption,mathtools,amsfonts, array, algpseudocode, algorithm, standalone, pgfplots, pgfplotstable, eqparbox, amssymb, subcaption, microtype}
\usepackage[nodisplayskipstretch]{setspace}
\addtolength\abovedisplayskip{-0.5\baselineskip}%
\addtolength\belowdisplayskip{-0.5\baselineskip}%
\usetikzlibrary{arrows,positioning,shapes.geometric, fit, automata, backgrounds, fillbetween, dateplot}
