...
\usepackage{ngerman,graphicx,epstopdf,float,latexsym,textcomp,longtable,verbatim,dsfont, color, tikz, url, csquotes,caption,mathtools,amsfonts, array, algpseudocode, algorithm, standalone, pgfplots, pgfplotstable, eqparbox, amssymb}
